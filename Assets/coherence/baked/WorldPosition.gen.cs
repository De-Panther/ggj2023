...
namespace Coherence.Generated
{
	...
	public struct WorldPosition : ICoherenceComponentData
	{
		...
		public static (WorldPosition, uint, uint?) DeserializeArchetypeCube_11d1f639851fbe64ebbe9a1d86320589_WorldPosition_LOD0(InProtocolBitStream bitStream)
		{
			var mask = (uint)0;
			var val = new WorldPosition();
			if (bitStream.ReadMask())
		...
		public static (WorldPosition, uint, uint?) DeserializeArchetypeVisualUser_3d8e0d6bf6d1f18448fd5924dc4297a2_WorldPosition_LOD0(InProtocolBitStream bitStream)
		{
			var mask = (uint)0;
			var val = new WorldPosition();
			if (bitStream.ReadMask())
